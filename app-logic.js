...
function goTab(pid){
  ...
  if(pid==='pg-home')updateDash();
  if(pid==='pg-notes'){backToUnits();renderUnitList();}
...
function flipFC(){document.getElementById('fc-card').classList.toggle('flip');fcFlipped=!fcFlipped;if(fcFlipped){fcReviewed++;sv('fcr',fcReviewed);updateDash();}}
